...
describe('developer console', () => {
  it('renders the operational workspace and runtime controls', async () => {
    ...
    vi.spyOn(platformApi, 'device').mockResolvedValue({ summary: { deviceId: 'pump-001', deviceType: 'pump', isRunning: true, deterministic: true, seed: 1, simulationTime: '00:00:01' }, runtime: { state: 'Running', time: '00:00:01', deviceId: 'pump-001', deviceType: 'pump', deterministic: true, seed: 1, scenario: { name: null, running: false }, activeFaults: 0 }, state: { speed: 900 }, definition: { id: 'pump-001', type: 'pump', deterministic: true, seed: 1, version: 1, dataPoints: [], commands: [], events: [], portBindings: [] }, protocols: [], scenarios: { running: false, available: [] }, faults: [], events: [] })
